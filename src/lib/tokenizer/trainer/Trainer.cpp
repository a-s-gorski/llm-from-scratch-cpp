...
namespace llm_fs::tokenizer::trainer {
    ...
    for (int i = 0; i < k; i++)
    {
        ...
        vocab[new_letter] = {max_pair->a, max_pair->b, new_letter, vocab[max_pair->a].token_list_len + vocab[max_pair->b].token_list_len, {}};
        vocab[new_letter].token_list.insert(vocab[new_letter].token_list.end(), vocab[max_pair->a].token_list.begin(), vocab[max_pair->a].token_list.end());
        vocab[new_letter].token_list.insert(vocab[new_letter].token_list.end(), vocab[max_pair->b].token_list.begin(), vocab[max_pair->b].token_list.end());
